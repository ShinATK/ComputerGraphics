...
{   
    ...
    //float z1 = (_v[1].x() - _v[0].x()) * (y - _v[0].y()) - (x - _v[0].x()) * (_v[1].y() - _v[0].y());
    //float z2 = (_v[2].x() - _v[1].x()) * (y - _v[1].y()) - (x - _v[1].x()) * (_v[2].y() - _v[1].y());
    //float z3 = (_v[0].x() - _v[2].x()) * (y - _v[2].y()) - (x - _v[2].x()) * (_v[0].y() - _v[2].y());
