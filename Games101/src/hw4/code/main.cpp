...
//#define METHOD01 // recursive_bezier Method 01
#define METHOD02 // recursive_bezier Method 02
...
double factorialC(int i, int n) {
    return factorialA(n) / (factorialA(i) * factorialA(n - i));
}
